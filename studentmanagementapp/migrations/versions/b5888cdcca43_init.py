...
Revision ID: b5888cdcca43
Revises: 
Create Date: 2024-12-20 00:21:36.150450
...
def upgrade():
    ...
    op.create_table('application_form',
                    ...
                    sa.Column('status', sa.Enum('PENDING', 'ACCEPTED', 'REJECTED', name='applicationformstatus'),
                              nullable=False),
    ...
    op.create_table('grade',
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
                    sa.Column('grade_type', sa.Enum('GRADE_10', 'GRADE_11', 'GRADE_12', name='gradetype'),
                              nullable=False),
    ...
    op.create_table('semester',
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
                    sa.Column('semester_type', sa.Enum('FIRST_TERM', 'SECOND_TERM', name='semestertype'),
                              nullable=False),
                    sa.Column('school_year_id', sa.Integer(), nullable=False),
                    sa.ForeignKeyConstraint(['school_year_id'], ['school_year.id'], ondelete='RESTRICT'),
                    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('classroom_transfer',
                    ...
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('student_info_id', 'classroom_id', 'transfer_date',
    ...
    op.create_table('transcript',
                    ...
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('classroom_id', 'curriculum_id', 'semester_id',
                                        name='uq_classroomid_curriculumid_semesterid')
                    )
    op.create_table('score',
                    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
                    sa.Column('score_number', sa.Float(), nullable=True),
                    sa.Column('score_type', sa.Enum('FIFTEEN_MINUTE', 'ONE_PERIOD', 'EXAM', name='scoretype'),
                              nullable=False),
                    sa.Column('student_info_id', sa.Integer(), nullable=False),
